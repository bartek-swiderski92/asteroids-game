...
// const game = new Game({guide: false, UI: {hpBarOptions: {currentHpBar: {fill: 'red', stroke: 'red'}, hpText: {innerHTML: 'HP'}}}});

// const game = new Game({guide: true, UI: {hpBarOptions: {currentHpBar: {fill: 'red', stroke: 'red'}, hpText: {innerHTML: 'this is some really long string'}}}});
